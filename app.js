...
function runAgent() {
  ...
  const html = `
    ...
    <article class="option recommendation">
      <span class="badge">🏆 MIN REKOMMENDATION · ${score}/100</span>
      <h2>${destination}</h2>
      <p class="muted">DestyPoint har tolkat din beskrivning och anpassat rekommendationen efter det du angav.</p>
      ...
      ${accommodationResult(destination, people, duration, text, budget)}
      ...
      <div class="good">✓ DestyPoint har byggt förslaget från din beskrivning. Aktiviteter visas bara när du själv har nämnt dem.</div>
    </article>`;
